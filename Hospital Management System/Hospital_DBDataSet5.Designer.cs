...
namespace Hospital_Management_System {
    ...
    public partial class Hospital_DBDataSet5 : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UserRow AddUserRow(string Name, string Address, string Email, string Password, string Gender, string Blood_Group, System.DateTime BirthDate, System.DateTime Joining_Date, string Marritial_Status, string User_Type, string Phone) {
...
namespace Hospital_Management_System.Hospital_DBDataSet5TableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[User] ([Name], [Address], [Email], [Password], [Gender], [Blood_Group], [BirthDate], [Joining_Date], [Marritial Status], [User_Type], [Phone]) VALUES (@Name, @Address, @Email, @Password, @Gender, @Blood_Group, @BirthDate, @Joining_Date, @Marritial_Status, @User_Type, @Phone);
SELECT User_Id, Name, Address, Email, Password, Gender, Blood_Group, BirthDate, Joining_Date, [Marritial Status], User_Type, Phone FROM [User] WHERE (User_Id = SCOPE_IDENTITY())";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Marritial_Status", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Marritial Status", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [Name] = @Name, [Address] = @Address, [Email] = @Email, [Password] = @Password, [Gender] = @Gender, [Blood_Group] = @Blood_Group, [BirthDate] = @BirthDate, [Joining_Date] = @Joining_Date, [Marritial Status] = @Marritial_Status, [User_Type] = @User_Type, [Phone] = @Phone WHERE (([User_Id] = @Original_User_Id) AND ([Name] = @Original_Name) AND ([Address] = @Original_Address) AND ([Email] = @Original_Email) AND ([Password] = @Original_Password) AND ([Gender] = @Original_Gender) AND ([Blood_Group] = @Original_Blood_Group) AND ([BirthDate] = @Original_BirthDate) AND ([Joining_Date] = @Original_Joining_Date) AND ([Marritial Status] = @Original_Marritial_Status) AND ([User_Type] = @Original_User_Type) AND ([Phone] = @Original_Phone));
SELECT User_Id, Name, Address, Email, Password, Gender, Blood_Group, BirthDate, Joining_Date, [Marritial Status], User_Type, Phone FROM [User] WHERE (User_Id = @User_Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT User_Id, Name, Address, Email, Password, Gender, Blood_Group, BirthDate, J" +
                "oining_Date, [Marritial Status], User_Type, Phone FROM dbo.[User]";
        ...
        public virtual int Fill(Hospital_DBDataSet5.UserDataTable dataTable) {
        ...
        public virtual Hospital_DBDataSet5.UserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Hospital_DBDataSet5.UserDataTable dataTable = new Hospital_DBDataSet5.UserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Hospital_DBDataSet5.UserDataTable dataTable) {
        ...
        public virtual int Delete(int Original_User_Id, string Original_Name, string Original_Address, string Original_Email, string Original_Password, string Original_Gender, string Original_Blood_Group, System.DateTime Original_BirthDate, System.DateTime Original_Joining_Date, string Original_Marritial_Status, string Original_User_Type, string Original_Phone) {
            ...
            if ((Original_Marritial_Status == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[9].Value = ((string)(Original_Marritial_Status));
            }
        ...
        public virtual int Insert(string Name, string Address, string Email, string Password, string Gender, string Blood_Group, System.DateTime BirthDate, System.DateTime Joining_Date, string Marritial_Status, string User_Type, string Phone) {
            if ((Name == null)) {
            ...
            if ((Marritial_Status == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[8].Value = ((string)(Marritial_Status));
            }
            if ((User_Type == null)) {
                throw new global::System.ArgumentNullException("User_Type");
            }
            else {
                this.Adapter.InsertCommand.Parameters[9].Value = ((string)(User_Type));
            }
            if ((Phone == null)) {
        ...
        public virtual int Update(
            ...
            if ((Marritial_Status == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Marritial_Status));
            }
            if ((User_Type == null)) {
                throw new global::System.ArgumentNullException("User_Type");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(User_Type));
            }
            if ((Phone == null)) {
                throw new global::System.ArgumentNullException("Phone");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[19].Value = ((System.DateTime)(Original_Joining_Date));
            if ((Original_Marritial_Status == null)) {
                throw new global::System.ArgumentNullException("Original_Marritial_Status");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[20].Value = ((string)(Original_Marritial_Status));
            }
            if ((Original_User_Type == null)) {
                throw new global::System.ArgumentNullException("Original_User_Type");
            }
        ...
        public virtual int Update(
                    ...
                    string Original_User_Type, 
                    string Original_Phone) {
            return this.Update(Name, Address, Email, Password, Gender, Blood_Group, BirthDate, Joining_Date, Marritial_Status, User_Type, Phone, Original_User_Id, Original_Name, Original_Address, Original_Email, Original_Password, Original_Gender, Original_Blood_Group, Original_BirthDate, Original_Joining_Date, Original_Marritial_Status, Original_User_Type, Original_Phone, Original_User_Id);
        }
    }
