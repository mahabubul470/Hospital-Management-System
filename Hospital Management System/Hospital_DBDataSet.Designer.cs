...
namespace Hospital_Management_System {
    ...
    public partial class Hospital_DBDataSet : global::System.Data.DataSet {
        ...
        public partial class PatientDataTable : global::System.Data.TypedTableBase<PatientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PatientRow AddPatientRow(string Name, string Address, string Phone, string Email, string BloodGroup, string Gender, System.DateTime Date_of_birth, string Assigned_Nurse, string Assigned_Docotor) {
...
namespace Hospital_Management_System.Hospital_DBDataSetTableAdapters {
    ...
    public partial class PatientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Patient] SET [Name] = @Name, [Address] = @Address, [Phone] = @Phone, [Email] = @Email, [BloodGroup] = @BloodGroup, [Gender] = @Gender, [Date_of_birth] = @Date_of_birth, [Assigned_Nurse] = @Assigned_Nurse, [Assigned_Docotor] = @Assigned_Docotor WHERE (([Patient_Id] = @Original_Patient_Id) AND ([Name] = @Original_Name) AND ([Address] = @Original_Address) AND ([Phone] = @Original_Phone) AND ([Email] = @Original_Email) AND ([BloodGroup] = @Original_BloodGroup) AND ([Gender] = @Original_Gender) AND ([Date_of_birth] = @Original_Date_of_birth) AND ((@IsNull_Assigned_Nurse = 1 AND [Assigned_Nurse] IS NULL) OR ([Assigned_Nurse] = @Original_Assigned_Nurse)) AND ((@IsNull_Assigned_Docotor = 1 AND [Assigned_Docotor] IS NULL) OR ([Assigned_Docotor] = @Original_Assigned_Docotor)));
SELECT Patient_Id, Name, Address, Phone, Email, BloodGroup, Gender, Date_of_birth, Assigned_Nurse, Assigned_Docotor FROM Patient WHERE (Patient_Id = @Patient_Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Patient_Id, Name, Address, Phone, Email, BloodGroup, Gender, Date_of_birth" +
                ", Assigned_Nurse, Assigned_Docotor FROM dbo.Patient";
        ...
        public virtual int Delete(int Original_Patient_Id, string Original_Name, string Original_Address, string Original_Phone, string Original_Email, string Original_BloodGroup, string Original_Gender, System.DateTime Original_Date_of_birth, string Original_Assigned_Nurse, string Original_Assigned_Docotor) {
            ...
            if ((Original_Assigned_Nurse == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[9].Value = ((string)(Original_Assigned_Nurse));
            }
            if ((Original_Assigned_Docotor == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[11].Value = ((string)(Original_Assigned_Docotor));
            }
        ...
        public virtual int Update(
            ...
            if ((Assigned_Nurse == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Assigned_Nurse));
            }
            if ((Assigned_Docotor == null)) {
                this.Adapter.UpdateCommand.Parameters[8].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Assigned_Docotor));
            }
            ...
            if ((Original_Assigned_Nurse == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((string)(Original_Assigned_Nurse));
            }
            if ((Original_Assigned_Docotor == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[20].Value = ((string)(Original_Assigned_Docotor));
            }
            this.Adapter.UpdateCommand.Parameters[21].Value = ((int)(Patient_Id));
        ...
        public virtual int Update(
                    ...
                    string Original_Assigned_Nurse, 
                    string Original_Assigned_Docotor) {
            return this.Update(Name, Address, Phone, Email, BloodGroup, Gender, Date_of_birth, Assigned_Nurse, Assigned_Docotor, Original_Patient_Id, Original_Name, Original_Address, Original_Phone, Original_Email, Original_BloodGroup, Original_Gender, Original_Date_of_birth, Original_Assigned_Nurse, Original_Assigned_Docotor, Original_Patient_Id);
        }
    }
