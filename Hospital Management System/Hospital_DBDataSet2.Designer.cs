...
namespace Hospital_Management_System {
    ...
    public partial class Hospital_DBDataSet2 : global::System.Data.DataSet {
        ...
        public partial class DoctorDataTable : global::System.Data.TypedTableBase<DoctorRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public DoctorRow AddDoctorRow(string Name, string Gender, string Blood_Group, System.DateTime BirthDate) {
...
namespace Hospital_Management_System.Hospital_DBDataSet2TableAdapters {
    ...
    public partial class DoctorTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Doctor] WHERE (([Doctor_Id] = @Original_Doctor_Id) AND ([Name]" +
                " = @Original_Name) AND ([Gender] = @Original_Gender) AND ([Blood_Group] = @Origi" +
                "nal_Blood_Group) AND ([BirthDate] = @Original_BirthDate))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Doctor] SET [Name] = @Name, [Gender] = @Gender, [Blood_Group] = @Blood_Group, [BirthDate] = @BirthDate WHERE (([Doctor_Id] = @Original_Doctor_Id) AND ([Name] = @Original_Name) AND ([Gender] = @Original_Gender) AND ([Blood_Group] = @Original_Blood_Group) AND ([BirthDate] = @Original_BirthDate));
SELECT Doctor_Id, Name, Gender, Blood_Group, BirthDate FROM Doctor WHERE (Doctor_Id = @Doctor_Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Doctor_Id, Name, Gender, Blood_Group, BirthDate FROM dbo.Doctor";
        ...
        public virtual int Delete(int Original_Doctor_Id, string Original_Name, string Original_Gender, string Original_Blood_Group, System.DateTime Original_BirthDate) {
            ...
            if ((Original_Blood_Group == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_Blood_Group));
            }
        ...
        public virtual int Update(string Name, string Gender, string Blood_Group, System.DateTime BirthDate, int Original_Doctor_Id, string Original_Name, string Original_Gender, string Original_Blood_Group, System.DateTime Original_BirthDate, int Doctor_Id) {
            if ((Name == null)) {
            ...
            if ((Blood_Group == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Blood_Group));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Gender, string Blood_Group, System.DateTime BirthDate, int Original_Doctor_Id, string Original_Name, string Original_Gender, string Original_Blood_Group, System.DateTime Original_BirthDate) {
            return this.Update(Name, Gender, Blood_Group, BirthDate, Original_Doctor_Id, Original_Name, Original_Gender, Original_Blood_Group, Original_BirthDate, Original_Doctor_Id);
        }
    }
