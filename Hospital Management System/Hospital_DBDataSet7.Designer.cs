...
namespace Hospital_Management_System {
    ...
    public partial class Hospital_DBDataSet7 : global::System.Data.DataSet {
        ...
        public partial class DoctorDataTable : global::System.Data.TypedTableBase<DoctorRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public DoctorRow AddDoctorRow(string Name, string Phone, string Email, string Gender, string Blood_Group, string Assigned_Patiend, string Speciality, string Designation) {
            ...
            private void InitClass() {
                ...
                this.columnAssigned_Patiend.AllowDBNull = false;
...
namespace Hospital_Management_System.Hospital_DBDataSet7TableAdapters {
    ...
    public partial class DoctorTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Doctor] WHERE (([Doctor_Id] = @Original_Doctor_Id) AND ([Name] = @Original_Name) AND ([Phone] = @Original_Phone) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ([Gender] = @Original_Gender) AND ([Blood_Group] = @Original_Blood_Group) AND ([Assigned_Patiend] = @Original_Assigned_Patiend) AND ([Speciality] = @Original_Speciality) AND ([Designation] = @Original_Designation))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Doctor] SET [Name] = @Name, [Phone] = @Phone, [Email] = @Email, [Gender] = @Gender, [Blood_Group] = @Blood_Group, [Assigned_Patiend] = @Assigned_Patiend, [Speciality] = @Speciality, [Designation] = @Designation WHERE (([Doctor_Id] = @Original_Doctor_Id) AND ([Name] = @Original_Name) AND ([Phone] = @Original_Phone) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ([Gender] = @Original_Gender) AND ([Blood_Group] = @Original_Blood_Group) AND ([Assigned_Patiend] = @Original_Assigned_Patiend) AND ([Speciality] = @Original_Speciality) AND ([Designation] = @Original_Designation));
SELECT Doctor_Id, Name, Phone, Email, Gender, Blood_Group, Assigned_Patiend, Speciality, Designation FROM Doctor WHERE (Doctor_Id = @Doctor_Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Doctor_Id, Name, Phone, Email, Gender, Blood_Group, Assigned_Patiend, Spec" +
                "iality, Designation FROM dbo.Doctor";
        ...
        public virtual int Fill(Hospital_DBDataSet7.DoctorDataTable dataTable) {
        ...
        public virtual Hospital_DBDataSet7.DoctorDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Hospital_DBDataSet7.DoctorDataTable dataTable = new Hospital_DBDataSet7.DoctorDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Hospital_DBDataSet7.DoctorDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Doctor_Id, string Original_Name, string Original_Phone, string Original_Email, string Original_Gender, string Original_Blood_Group, string Original_Assigned_Patiend, string Original_Speciality, string Original_Designation) {
            ...
            if ((Original_Assigned_Patiend == null)) {
                throw new global::System.ArgumentNullException("Original_Assigned_Patiend");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[7].Value = ((string)(Original_Assigned_Patiend));
            }
        ...
        public virtual int Update(
            ...
            if ((Assigned_Patiend == null)) {
                throw new global::System.ArgumentNullException("Assigned_Patiend");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Assigned_Patiend));
            }
            if ((Speciality == null)) {
            ...
            if ((Original_Assigned_Patiend == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((string)(Original_Assigned_Patiend));
            }
            if ((Original_Speciality == null)) {
                throw new global::System.ArgumentNullException("Original_Speciality");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[18].Value = ((int)(Doctor_Id));
        ...
        public virtual int Update(
                    ...
                    string Original_Speciality, 
                    string Original_Designation) {
            return this.Update(Name, Phone, Email, Gender, Blood_Group, Assigned_Patiend, Speciality, Designation, Original_Doctor_Id, Original_Name, Original_Phone, Original_Email, Original_Gender, Original_Blood_Group, Original_Assigned_Patiend, Original_Speciality, Original_Designation, Original_Doctor_Id);
        }
    }
