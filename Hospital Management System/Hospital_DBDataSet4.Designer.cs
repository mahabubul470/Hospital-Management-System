...
namespace Hospital_Management_System {
    ...
    public partial class Hospital_DBDataSet4 : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UserRow AddUserRow(string Name, string Email, string Gender, string Blood_Group, string User_Type, string Phone) {
...
namespace Hospital_Management_System.Hospital_DBDataSet4TableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[User] WHERE (([User_Id] = @Original_User_Id) AND ([Name] = @Original_Name) AND ([Email] = @Original_Email) AND ([Gender] = @Original_Gender) AND ([Blood_Group] = @Original_Blood_Group) AND ([User_Type] = @Original_User_Type) AND ([Phone] = @Original_Phone))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [Name] = @Name, [Email] = @Email, [Gender] = @Gender, [Blood_Group] = @Blood_Group, [User_Type] = @User_Type, [Phone] = @Phone WHERE (([User_Id] = @Original_User_Id) AND ([Name] = @Original_Name) AND ([Email] = @Original_Email) AND ([Gender] = @Original_Gender) AND ([Blood_Group] = @Original_Blood_Group) AND ([User_Type] = @Original_User_Type) AND ([Phone] = @Original_Phone));
SELECT User_Id, Name, Email, Gender, Blood_Group, User_Type, Phone FROM [User] WHERE (User_Id = @User_Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT User_Id, Name, Email, Gender, Blood_Group, User_Type, Phone FROM dbo.[User" +
                "]";
        ...
        public virtual int Fill(Hospital_DBDataSet4.UserDataTable dataTable) {
        ...
        public virtual Hospital_DBDataSet4.UserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Hospital_DBDataSet4.UserDataTable dataTable = new Hospital_DBDataSet4.UserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Hospital_DBDataSet4.UserDataTable dataTable) {
        ...
        public virtual int Delete(int Original_User_Id, string Original_Name, string Original_Email, string Original_Gender, string Original_Blood_Group, string Original_User_Type, string Original_Phone) {
        ...
        public virtual int Update(string Name, string Email, string Gender, string Blood_Group, string User_Type, string Phone, int Original_User_Id, string Original_Name, string Original_Email, string Original_Gender, string Original_Blood_Group, string Original_User_Type, string Original_Phone, int User_Id) {
            if ((Name == null)) {
            ...
            if ((Original_Blood_Group == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_Blood_Group));
            }
            if ((Original_User_Type == null)) {
                throw new global::System.ArgumentNullException("Original_User_Type");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Email, string Gender, string Blood_Group, string User_Type, string Phone, int Original_User_Id, string Original_Name, string Original_Email, string Original_Gender, string Original_Blood_Group, string Original_User_Type, string Original_Phone) {
            return this.Update(Name, Email, Gender, Blood_Group, User_Type, Phone, Original_User_Id, Original_Name, Original_Email, Original_Gender, Original_Blood_Group, Original_User_Type, Original_Phone, Original_User_Id);
        }
    }
